...
# 📖 [React on Rails App] <a name="about-project"></a>

**[React on Rails App] ** is a project from the sixth module of the Microverse program.
...
- Clone [this repository](https://github.com/Kwaleyela-Ikafa/my_new_rails_app.git)
